...
export const ContactSection = () => {
  return <section id="contact" className="py-24 bg-gradient-to-br from-rose-100/80 via-pink-50/70 to-red-50/60 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6">
            {/* WhatsApp */}
            <Button className="h-auto p-6 bg-white/90 hover:bg-white/95 backdrop-blur-xl border border-white/50 text-gray-700 hover:text-[#FFA300] rounded-2xl group shadow-lg" variant="outline">
            ...
            <Button className="h-auto p-6 bg-white/90 hover:bg-white/95 backdrop-blur-xl border border-white/50 text-gray-700 hover:text-[#FFA300] rounded-2xl group shadow-lg" variant="outline">
              <div className="flex items-center space-x-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm opacity-70">+8801881-591312</p>
                </div>
              </div>
            </Button>
          </div>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex justify-center space-x-4">
              <Button variant="outline" size="icon" className="bg-white/90 hover:bg-white/95 backdrop-blur-xl border border-white/50 hover:border-blue-500 rounded-full shadow-lg">
                <Facebook className="h-5 w-5 text-blue-600" />
              </Button>
              
              <Button variant="outline" size="icon" className="bg-white/90 hover:bg-white/95 backdrop-blur-xl border border-white/50 hover:border-pink-500 rounded-full shadow-lg">
